          ...
          <div className="row ">
            <div className="intro-content col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-lg d-flex justify-content-center align-items-center align-items-md-start align-items-sm-start">
              <div className="title-img">
                <img
                  src="./assets/pinki.png"
                  alt="Myda"
                  className="text-image"
                />
                <h2 className="intro-title">
                  <span className="span">Myda Gilani</span>
                </h2>
              </div>
              <div className="d-flex flex-column justify-content-start header-p-btn">
                <p className="intro-description">
                  I am a natural leader. I thrive in the company of friends and
                  my family. I enjoy crocheting, music, community engagement,
                  sports and languages. Each of these experiences has shaped who
                  I am and continues to fuel my creativity and personal growth.{" "}
                </p>
              ...
              <div className="about-padding">
                ...
                <div className="about-margin-lft">
                  <p className="section-description">
                    I started my creative journey early, from learning
                    crocheting during the pandemic to playing the piano and
                    actively engaging in my community. Whether it's through
                    sports or volunteering, I find joy in leadership and
                    personal growth. Every experience has given me new
                    perspectives, and I'm excited to learn and grow as an
                    individual and a community member.{" "}
                  </p>
